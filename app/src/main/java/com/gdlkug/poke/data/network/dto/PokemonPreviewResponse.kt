...
fun List<PokemonPreviewResponse>.toPokemon() = map(PokemonPreviewResponse::toPokemon)
...
fun List<PokemonPreviewResponse>.toPokemonEntity() = map(PokemonPreviewResponse::toPokemonEntity)
